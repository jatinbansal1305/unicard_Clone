...
const Footer = () => {
  return (
    <section>
    <div className="relative w-full bg-black bg-opacity-100">
      <div className="flex items-center justify-center p-4 text-[rgba(141,141,149,1)]">
    ...
    <div
      ...
      className="flex flex-col items-center bg-[rgba(18,18,18,1)] text-white pt-[30px] px-4 md:px-14 md:pt-[50px] pb-40"
    ...
    >
      <div className="w-full max-w-[1240px] min-h-[auto]">
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-start">
          <div className="flex flex-col w-full lg:w-1/2 items-start">
            ...
            <div className="text-[rgba(141,141,149,1)] text-[13px] lg:text-base">
      ...
      <div class="bg-gradient-to-r from-teal-400 via-teal-400 to-yellow-200 h-[1px] w-full max-w-[1240px] mx-0 mt-8 mb-5 md:mb-8" style={{transform: 'scale-y-[-1]',}}></div>
      <div className="spacer-gradient h-[1px] w-full max-w-[1240px] mx-0 mt-8 mb-5 md:mb-8" />
